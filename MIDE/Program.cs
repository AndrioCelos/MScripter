...
namespace MIDE {
    ...
    public static class Program {
        ...
        public static string ConfigFileDefault
            => Path.Combine(Environment.GetFolderPath(SpecialFolder.ApplicationData), "MIDE", "config.json");
        ...
        public static void SaveConfig() {
            string filePath = "config.json";
            if (!File.Exists(filePath)) {
                filePath = Path.Combine(Environment.GetFolderPath(SpecialFolder.ApplicationData), "MIDE");
