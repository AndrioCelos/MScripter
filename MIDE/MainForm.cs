    ...
    public partial class MainForm : Form {
        ...
        public MainForm(IEnumerable<string> filePaths, Exception configFailure) {
            ...
            if (configFailure != null) {
                ...
                errorBuilder.Append("\n;   The file has been opened for editing. After editing it, restart MIDE.\n");
            }
        ...
        private void saveDocumentAs(TabPage tabPage) {
            ...
            if (result == System.Windows.Forms.DialogResult.OK) {
                ...
                if (type != document.Type && MessageBox.Show(this, "This file was " + (document.Type == DocumentType.AliasScript ? "an " : "a ") + Program.GetTypeString(document.Type) +
                    ...
                    "MIDE", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) == DialogResult.No) return;
        ...
        private void closeToolStripMenuItem1_Click(object sender, EventArgs e) {
            if (currentItem != null) {
                ...
                if (currentItem is MslDocument && ((MslDocument) currentItem).Modified) {
                    switch (MessageBox.Show("Will you save your changes to the file?", "MIDE", MessageBoxButtons.YesNoCancel)) {
        ...
        private void revertToolStripMenuItem_Click(object sender, EventArgs e) {
            if (currentItem != null) {
                // Ask if the user wants to save the file.
                if (currentItem is MslDocument && ((MslDocument) currentItem).Modified) {
                    if (MessageBox.Show("Are you sure you want to discard your changes?", "MIDE", MessageBoxButtons.YesNo) == DialogResult.Yes) {
                    }
                }
            }
        }
        ...
        private void goTodefinitionToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            MessageBox.Show(this, "The alias was not found.", "MIDE", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
