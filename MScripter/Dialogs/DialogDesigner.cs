...
namespace MScripter {
    public partial class DialogDesigner : UserControl {
        ...
        private void RedrawLayout() {
            ...
            layoutGraphics.DrawIcon(MScripter.Properties.Resources.dialogIcon, new Rectangle(11, 10, 16, 16));
            ...
            foreach (string s in Clipboard.GetText().Split(new string[] { "\r\n", "\n", "\r" }, StringSplitOptions.RemoveEmptyEntries)) {
                ...
                if (control is MslMenu) {
                    ...
                    if (control is MslMenu.MslItem && parent == null) {
                        MessageBox.Show("Can't add an item to the top level. Select a menu before pasting to add it as a child to that menu.", "MScripter", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        continue;
                    }
